...
design_libs=(xil_defaultlib blk_mem_gen_v8_4_11)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../Xilinx2025/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../Xilinx2025/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ariane/Documentos/faculdade/semestre_5/sistemas_digitais/praticas/CPU/CPU.cache/compile_simlib/vcs"
  fi
