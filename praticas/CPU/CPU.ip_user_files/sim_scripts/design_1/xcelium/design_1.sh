...
#
# Script generated by Vivado on Fri Jul 11 10:42:07 -03 2025
...
design_libs_elab="-libname xil_defaultlib -libname blk_mem_gen_v8_4_11 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib blk_mem_gen_v8_4_11)
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../../../Xilinx2025/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../Xilinx2025/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ariane/Documentos/faculdade/semestre_5/sistemas_digitais/praticas/CPU/CPU.cache/compile_simlib/xcelium"
  fi
